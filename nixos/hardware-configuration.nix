...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/49a0d9af-25c8-4e8c-84c4-a570db847dac";
      fsType = "ext4";
    };

  fileSystems."/boot/efi" =
    { device = "/dev/disk/by-uuid/31FC-2E30";
      fsType = "vfat";
    };
  ...
  # hardware.video.hidpi.enable = lib.mkDefault true; # Is no effect
}
